...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(terraform-mode prettier-js add-node-modules-path eslint-fix evil-rsi keyfreq)
...
you should place your code here."
  ...
  ;; (setq spacemacs-useless-buffers-regexp '("\\s\*\\*\.\+\\*"))
