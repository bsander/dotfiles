...
This function should only modify configuration layer settings."
  (setq-default
   ...
   dotspacemacs-additional-packages '(
                                      ;; evil-visual-replace evil-easymotion
                                      terraform-mode prettier-js eslint-fix keyfreq
                                      editorconfig flatland-theme rjsx-mode
                                      treemacs-evil add-node-modules-path
                                      auto-dim-other-buffers graphql-mode format-all
                                      elisp-format bln-mode
                                      gruvbox-theme graphviz-dot-mode)
...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  ...
  ;; Attempt to lax shitty garbage collection settings
  ...
  ;; Set hard limit since this sometimes goes out of control (does not help)
  ...
  ;; From https://github.com/frankjonen/emacs-for-writers/blob/master/.spacemacs
...
before packages are loaded."
  ...
  ;; ;; install evil-easymotion keybindings
  ...
  ;; ;; Keep point centered on screen as much as possible (SPC t -)
  ;; (centered-cursor-mode)

  ;; auto revert files when contents on disk change
  ...
  ;; Save open window and buffer states on exit
  ;; (desktop-save-mode 1)

  ;; Preserve minibuffer and killring history
  (savehist-mode 1)
  ...
  (setq keyfreq-excluded-commands
        '(self-insert-command abort-recursive-edit))
...
(defhydra hydra-bln ()
  ...
  ("K" bln-backward-half-b "Backward in buffer")
  ("J" bln-forward-half-b "Forward in buffer"))
  (spacemacs/set-leader-keys "jb" 'hydra-bln/body)
  ...
  ;; ;; Run eslint after lsp-ui -- TODO may not be compatible with other languages
  ;; (eval-after-load 'lsp-ui-mode
  ;;   '(add-hook 'lsp-ui-mode-hook
  ;;              (lambda () (flycheck-add-next-checker 'lsp-ui '( warning . javascript-eslint ))) )
  ;;   )
  ...
  (define-key evil-normal-state-map (kbd "gj") (kbd "G"))
  (define-key evil-normal-state-map (kbd "gk") (kbd "gg"))
  (define-key evil-normal-state-map (kbd "gl") (kbd "$"))

  ;; Specify directory then grep for contents
  (spacemacs/set-leader-keys "?" 'spacemacs/helm-files-smart-do-search)
  (spacemacs/set-leader-keys "hb" 'helm-descbinds) ;; rebind original key for "?"
  ...
  ;; Second attempt at separating clipboard and kill ring
  ...
  ;;   '(progn
  ;;      (define-key yas-keymap (kbd "<return>") 'extend-comment)))
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (vimrc-mode helm-gtags ggtags dactyl-mode counsel-gtags counsel flycheck-rust flycheck-pos-tip swiper ivy yasnippet yasnippet-snippets yaml-mode ws-butler writeroom-mode winum which-key web-mode web-beautify volatile-highlights vmd-mode uuidgen use-package unfill typescript-mode treemacs-projectile treemacs-evil toml-mode toc-org terraform-mode tagedit symon symbol-overlay string-inflection sql-indent spaceline-all-the-icons smeargle slim-mode scss-mode sass-mode rjsx-mode reveal-in-osx-finder restclient-helm restart-emacs rainbow-delimiters racer pug-mode prettier-js popwin persp-mode pcre2el password-generator paradox overseer osx-trash osx-dictionary osx-clipboard orgit org-projectile org-present org-pomodoro org-mime org-download org-cliplink org-bullets org-brain open-junk-file ob-restclient ob-http nodejs-repl nameless mwim move-text mmm-mode markdown-toc magit-svn magit-gitflow macrostep lsp-ui lsp-treemacs lorem-ipsum livid-mode link-hint launchctl keyfreq json-navigator js2-refactor js-doc insert-shebang indent-guide impatient-mode hungry-delete hl-todo highlight-parentheses highlight-numbers highlight-indentation helm-xref helm-themes helm-swoop helm-purpose helm-projectile helm-org-rifle helm-mode-manager helm-make helm-lsp helm-gitignore helm-git-grep helm-flx helm-descbinds helm-css-scss helm-company helm-c-yasnippet helm-ag gruvbox-theme graphviz-dot-mode graphql-mode google-translate golden-ratio gnuplot gitignore-templates gitconfig-mode gitattributes-mode git-timemachine git-messenger git-link git-gutter-fringe git-gutter-fringe+ gh-md fuzzy format-all font-lock+ flycheck-package flycheck-bashate flx-ido flatland-theme fish-mode fill-column-indicator fancy-battery eyebrowse expand-region evil-visualstar evil-visual-mark-mode evil-unimpaired evil-tutor evil-textobj-line evil-surround evil-snipe evil-org evil-numbers evil-nerd-commenter evil-mc evil-matchit evil-magit evil-lisp-state evil-lion evil-indent-plus evil-iedit-state evil-goggles evil-exchange evil-escape evil-ediff evil-cleverparens evil-args evil-anzu eslint-fix emmet-mode elisp-slime-nav elisp-format editorconfig dumb-jump dotenv-mode doom-modeline dockerfile-mode docker diminish diff-hl devdocs deft dap-mode csv-mode counsel-projectile company-web company-tern company-statistics company-shell company-restclient company-lsp column-enforce-mode clojure-snippets clean-aindent-mode cider-eval-sexp-fu cider centered-cursor-mode cargo browse-at-remote bln-mode auto-yasnippet auto-highlight-symbol auto-dim-other-buffers auto-compile aggressive-indent add-node-modules-path ace-link ace-jump-helm-line ac-ispell))))
(custom-set-faces
